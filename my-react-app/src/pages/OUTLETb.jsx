...
<div className="Red"> 
   ...
   onMouseMove={handleMouseMove}
      style={{
        backgroundImage: `url(${"OUTLETS/PRODUCT2/A.avif"})`,
...
<div className="Red"> 
   ...
   onMouseMove={handleMouseMovea}
      style={{
        backgroundImage: `url(${"OUTLETS/PRODUCT2/B.avif"})`,
        backgroundPosition: backgroundPosition,
        backgroundSize: '200%', // zoom level
        backgroundRepeat: 'no-repeat',
        border: '1px solid #ccc',
...
<div className="blue">
   ...
   onMouseMove={handleMouseMoveb}
      style={{
        backgroundImage: `url(${"OUTLETS/PRODUCT2/C.avif"})`,
        backgroundPosition: backgroundPosition,
        backgroundSize: '200%', // zoom level
        backgroundRepeat: 'no-repeat',
        border: '1px solid #ccc',
...
<div className="Red"> 
   ...
   onMouseMove={handleMouseMovec}
      style={{
        backgroundImage: `url(${"OUTLETS/PRODUCT2/D.avif"})`,
        backgroundPosition: backgroundPosition,
        backgroundSize: '200%', // zoom level
        backgroundRepeat: 'no-repeat',
        border: '1px solid #ccc',
