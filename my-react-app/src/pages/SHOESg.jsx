...
<div
    ...
    >
     ...
     <img src="SHOES/PRODUCT7/A.avif" alt="k" className="image-1" w/>
     ...
     <img src="SHOES/PRODUCT7/B.avif" alt="k" className="image-2" w/>
    ...
    <div className="grid-container">
     ...
     <img src="SHOES/PRODUCT7/C.avif" alt="k" className="image-3" w/>
  
      </h2>
      <h2 className="text-lggg font-semibold text-[#030303]">
     <img src="SHOES/PRODUCT7/D.avif" alt="k" className="image-4" w/>
