...
<div
    ...
    >
     ...
     <img src="WOMEN/PRODUCT6/A.avif" alt="k" className="image-1" w/>
     ...
     <img src="WOMEN/PRODUCT6/B.avif" alt="k" className="image-2" w/>
    ...
    <div className="grid-container">
     ...
     <img src="WOMEN/PRODUCT6/C.avif" alt="k" className="image-3" w/>
  
      </h2>
      <h2 className="text-lggg font-semibold text-[#030303]">
     <img src="WOMEN/PRODUCT6/D.avif" alt="k" className="image-4" w/>
