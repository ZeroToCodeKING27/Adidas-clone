...
<div>
  ...
  <p className="secoond-header">Men's Outlet </p>
</div>
<div className="x">
  <ul>
...
<div className="NEW-ARRIVAL-GAP-GRIDS">
 <a href="OUTLETa" target="_self" >    <img src="OUTLETS/PRODUCT1/A.avif" alt="k" width="1000px" className="NEW-ARRIVAL"/>
 <p>
...
<p>
  <span className="Fourth-p">2 colours</span>
   ...
   <a href="OUTLETb" target="_self" >   <img src="OUTLETS/PRODUCT2/A.avif" alt="k" width="1000px" className="NEW-ARRIVAL"/>
   <p>
 <span className="First-p">Xperior Shorts</span>
 </p>
 <p>
...
<p>
  ...
  <a href="OUTLETc" target="_self" >     <img src="OUTLETS/PRODUCT3/A.avif" alt="k" width="1000px" className="NEW-ARRIVAL"/>
  <p>
 <span className="First-p">Xperior Shorts</span>
 </p>
 <p>
...
<p>
  <span className="Fourth-p">2 colours</span>
    ...
    <a href="OUTLETd" target="_self" >        <img src="OUTLETS/PRODUCT4/A.avif" alt="k" width="1000px" className="NEW-ARRIVAL"/>
    <p>
 <span className="First-p">Xperior Shorts</span>
 </p>
 <p>
