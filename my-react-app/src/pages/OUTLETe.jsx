...
<div
    ...
    >
     ...
     <img src="OUTLETS/PRODUCT5/A.avif" alt="k" className="image-1" w/>
     ...
     <img src="OUTLETS/PRODUCT5/B.avif" alt="k" className="image-2" w/>
    ...
    <div className="grid-container">
     ...
     <img src="OUTLETS/PRODUCT5/C.avif" alt="k" className="image-3" w/>
  
      </h2>
      <h2 className="text-lggg font-semibold text-[#030303]">
     <img src="OUTLETS/PRODUCT5/D.avif" alt="k" className="image-4" w/>
