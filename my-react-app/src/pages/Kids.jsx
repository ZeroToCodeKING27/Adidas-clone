...
<div className="first-header-section">
  <p> <u>Running</u> /Shoes</p>
</div>
<div>
 
  <p className="secoond-header">Running Shoes </p>
</div>
<div className="x">
  <ul>
...
<div className="NEW-ARRIVAL-GAP-GRIDS">
 <a href="Kidsa" target="_self" ><img src="KIDS/PRODUCT1/A.avif" alt="k" width="1000px" className="NEW-ARRIVAL"/>
 <p>
...
<p>
 ...
 <a href="Kidsb" target="_self" ><img src="KIDS/PRODUCT2/A.avif" alt="k" width="1000px" className="NEW-ARRIVAL"/>
 <p>
 <span className="First-p">Xperior Shorts</span>
 </p>
 <p>
...
<p>
  <span className="Fourth-p">2 colours</span>
    ...
    <a href="Kidsc" target="_self" > <img src="KIDS/PRODUCT3/A.avif" alt="k" width="1000px" className="NEW-ARRIVAL"/>
    <p>
 <span className="First-p">Xperior Shorts</span>
 </p>
 <p>
...
<p>
  <span className="Fourth-p">2 colours</span>
     ...
     <a href="Kidsd" target="_self" ><img src="KIDS/PRODUCT4/A.avif" alt="k" width="1000px" className="NEW-ARRIVAL"/>
     <p>
 <span className="First-p">Xperior Shorts</span>
 </p>
 <p>
