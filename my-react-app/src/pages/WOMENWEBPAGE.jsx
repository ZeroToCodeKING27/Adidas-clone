...
return (
      ...
      <img src="public/WOMENWEBPAGE/za-superstar-originals-fw25-launch-klp-mh-d.jpg" alt="k" width="100px"  className="image-1-About"/>
 ...
 <button className="SHOW-NOW-Button">SHOW NOW</button>
      ...
      <img src="public/WOMENWEBPAGE/em-za-lightblaze-wglp-mh-d.jpg" alt="k" width="100px"  className="image-1-Mercedez"/>
...
<div className="Home-template-grids-1">
  <div class="template-1"><p className="P-template-1">Samba</p><hr className="hr-home-page"></hr></div>
  <div class="template-1"><p className="P-template-1">Shoes</p><hr className="hr-home-page"></hr></div>
  <div class="template-1"><p className="P-template-1">campus</p><hr className="hr-home-page"></hr></div>
</div>
<div className="Home-template-grids-1">
  <div class="template-1"><p className="P-template-1">spezial</p><hr className="hr-home-page"></hr></div>
  <div class="template-1"><p className="P-template-1">soccer boots</p><hr className="hr-home-page"></hr></div>
</div>
</>
...
<>
<h2 className="div-button-home">
  <button className="arrival-button">New arrival</button>
  <button className="button-Home">Trending</button>
  <button className="button-Home">Adizero EVO SL</button>
  <button className="button-Home">Rain Jackets</button>
  <button className="button-Home">Sneakerino</button>
</h2>
...
<div className="Home-template-grids-5">
  <div class="template">Template 1</div>
  <div class="template">Template 2</div>
  <div class="template">Template 3</div>
  <div class="template">Template 4</div>
    <div class="template">Template 5</div>
</div>
</>
<>
